...
def title(msg):
    ...
    chromedriver_dir = r"C:\Users\민찬\Desktop\chromedriver.exe"
...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity=discord.Game("음악 듣기"))
...
async def 시작(ctx):
    try:
        ...
        try:
            ...
            await ctx.send("채널에 유저가 접속되있지 않네요")
...
bot.run('ODYzNzM5MTM4MTIwMjIwNjcy.YOrRwg.LR7r7MrJfoyOoZoy4VepvHUzQWs')